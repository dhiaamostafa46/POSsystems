...
<body class="hold-transition login-page"  style="direction: rtl;font-family:boutros ;background: url('{{asset('dist/img/ww.jpeg')}}') no-repeat; background-position: center;background-attachment: fixed; background-size: cover !important;">
