        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item @if(session('page')=='invoices') menu-open @endif">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('Treasury.index')}}" onclick="createInvoice();" class="nav-link @if(session('sub-page')=='getItemsInvoice') active-sub-page @endif">
                  <i class="fa fa-file nav-icon"></i>
                  <p>الخزائن</p>
                </a>
              </li>
              ...
              @if(auth()->user()->role->permissions->contains('pageID', $pages->where('code','createReceivePayments')->first()->id))
              <li class="nav-item">
                <a href="{{route('Bank.index')}}" class="nav-link @if(session('sub-page')=='createReceivePayments') active-sub-page @endif">
                  <i class="fa fa-file nav-icon"></i>
                  <p>البنوك </p>
                </a>
              </li>
      ...
      @if(
            ...
            <li class="nav-item @if(session('page')=='HR') menu-open @endif">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item @if(session('page')=='Settings') menu-open @endif">
             ...
             <li class="nav-item @if(session('page')=='Profile') menu-open @endif">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  ...
                  <a href="#" class="nav-link @if(session('sub-page')=='ProfileInfCompany') active-sub-page @endif">
                ...
                <li class="nav-item">
                  ...
                  <a href="#" class="nav-link @if(session('sub-page')=='ProfileInfServices') active-sub-page @endif">
                    <i class="fa fa-asterisk nav-icon"></i>
                    <p>الباقات </p>
                  </a>
                </li>
                <li class="nav-item">
                  ...
                  <a href="#" class="nav-link @if(session('sub-page')=='ProfileInfContact') active-sub-page @endif">
                    <i class="fa fa-asterisk nav-icon"></i>
                    <p>   معلومات التواصل  </p>
                  </a>
                </li>
            ...
            <li class="nav-item @if(session('page')=='outcomes') menu-open @endif">
              ...
              <ul class="nav nav-treeview">
                @if(auth()->user()->role->permissions->contains('pageID', $pages->where('code','organizationView')->first()->id))
          <li class="nav-item">
            <a type="button"  onclick="getLink();" href="#" class="nav-link @if(session('page')=='organizations') active-page @endif">
...
<div class="modal fade modal" id="linkModel" tabindex="-1" role="dialog" aria-labelledby="linkModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-center" id="exampleModalLabel">رابط المنشأة</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-left:0px">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
