...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg"> تسجيل الدخول المندوب </p>
      ...
      <div class="row">
        <!-- /.col -->
         <div class="col-12">
           <a href="{{route('Shop.Register',$orgID)}}" class="btn btn-primary btn-block mt-2 ">  سجل معنا  </a>
         </div>
         <!-- /.col -->
       </div>
       <div class="row">
        <!-- /.col -->
         <div class="col-12">
           <a href="{{ route('public.index', $orgID) }}"  class="btn btn-primary btn-block mt-2 ">   رجوع الى المتجر   </a>
         </div>
         <!-- /.col -->
       </div>
