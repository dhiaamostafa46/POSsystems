    ...
    <div class="row">
      <div class="col-12">
        <div class="card card-primary">
          ...
          <div class="card-body">
            <form class="user" method="post" action="{{route('ProfileInfCompany.Servicesupdate',$profCompany->id)}}" enctype = "multipart/form-data">
              @csrf
              @method('PUT')
              <div class="pl-lg-4">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text"  class="form-control text-right" id="name" name="name" rows="4" value="{{$profCompany->name}}" >
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <textarea class="form-control text-right" id="disc" name="disc" rows="4" >{{$profCompany->disc}}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
