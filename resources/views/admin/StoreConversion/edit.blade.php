      ...
      <div class="container-fluid">
       ...
       <div class="col-12 card card-primary">
        <div class="card-header">
          <h3 class="card-title">تحويل صادر  </h3>
        </div>
       </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group text-left">
                              <h6> الاجمالي التكلفة</h6>
                              <h6> الاجمالي الكمية</h6>
                              <h6> متوسط التكلفة </h6>
                            </div>
                          </div>
                          <div class="col-lg-2">
    ...
    $( document ).ready(function() {
              ...
              count=0;
                    ...
                    @foreach( $store->StoreConversiondetails as $index => $product )
                        ...
                        data = data+' <td><input type="text"  readonly class="form-control text-center" id="Countitems{{$index+1}}" name="Countitems{{$index+1}}" value="${cost }"></td>';
