      ...
      <div class="col-12">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">  {{ trans('Store.Addmanufacturingorder') }}  </h3>
          </div>
          <div class="card-body">
            <form class="user" method="POST" action="{{route('Manufactur.store')}}" enctype = "multipart/form-data">
                @csrf
            <input type="hidden" name="idprodect" value="{{$vom->ProdectID}}">
            <input type="hidden" name="idvom" value="{{$vom->id}}">
            <input type="hidden" name="Count" id="Count" value="{{$vom->countVol}}">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input type="number"  class="form-control" name="Quantity" value="{{$vom->totalguenty}}" onchange="calculation()" id="Quantity">
                      @error('name')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
                        ...
                        <tbody>
                              ...
                              <?php $cc=0;?>
                                  ...
                                  <tr>
                                      ...
                                      <td><input  class="form-control" type="text" readonly name="costprod{{$index+1}}" id="costprod{{$index+1}}" value="{{$details->product->unitprodectcommentbreanch[0]->costprodect ?? ''}}"></td>
