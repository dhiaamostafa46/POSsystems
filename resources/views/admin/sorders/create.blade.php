      ...
      <div class="container-fluid">
        ...
        <div class="row mt-2">
          ...
          <div class="col-12">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <input type="text" class="form-control @error('reciever') is-invalid @enderror" id="reciever" name="reciever" placeholder="اسم المستلم" required>
                          @error('reciever')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
            ...
            oninput="this.setCustomValidity('')" minlength="10" class="form-control @error('recieverPhone') is-invalid @enderror" id="recieverPhone" name="recieverPhone" placeholder="رقم الجوال" required>
                          @error('recieverPhone')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          <input type="text" class="form-control @error('deliver') is-invalid @enderror" id="deliver" name="deliver" placeholder="اسم المسلّم" required>
                          @error('deliver')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          <input type="text" class="form-control @error('comment') is-invalid @enderror" id="comment" name="comment" placeholder="اكتب تعليقك" required>
                          @error('comment')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
