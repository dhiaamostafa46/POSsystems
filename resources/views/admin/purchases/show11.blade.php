...
<div class="invoice print">
  ...
  <div class="row" style="margin-top: 0px;">
    ...
    <div class="col-6">
      <h6 style="text-align: center;margin:5px">فاتورة مشتريات</h6>
    ...
    <table class="col-12 mt-3 border for-print" style="margin:auto;float:none;text-align:center;padding:5px" >
      ...
      <tfoot>
        <tr>
          ...
          <td style="background-color: rgb(202, 199, 199);font-size:small">{{$purchase->totalwvat - $purchase->totalvat}}</td>
        </tr>
        <tr>
          <td colspan="5" style="background-color: rgb(202, 199, 199);font-size:small;height:30px"> مجموع ضريبة القيمة المضافة  Total VAT</td>
          <td style="background-color: rgb(202, 199, 199);font-size:small">{{$purchase->totalvat}}</td>
        </tr>
        <tr>
          ...
          <td style="background-color: rgb(202, 199, 199);font-size:small">{{$purchase->totalwvat}}</td>
        </tr>
      </tfoot>
    </table>
  </div>
