                        ...
                        <tbody>
                              ...
                              @if (count( $purchase->purchasedetails) > 0)
                                  ...
                                  <tr>
                                      ...
                                      <td>{{number_format(($details->price * $details->quantity)*0.15,2)}}</td>
                                      <td>{{number_format(($details->price * $details->quantity) +(($details->price * $details->quantity)*0.15),2)}}</td>
                                  </tr>
                                  @endforeach
                              @endif
                        ...
                        <tbody>
                            ...
                            @if ($purchase->discount != 0 || $purchase->discount !=null )
                                <tr class="cs-border_left">
                                    ...
                                    <td
                                        class="cs-width_2 cs-semi_bold cs-focus_bg cs-primary_color cs-text_right">
                                        {{ number_format($purchase->totalwvat * ($purchase->discount / 100), 2) }} {{ trans('Sale.Rial') }}
                                    </td>
                                </tr>
                            @endif
