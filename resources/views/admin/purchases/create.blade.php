      ...
      <div class="container-fluid">
       ...
       <div class="col-12 card card-primary">
        <div class="card-header">
          <h3 class="card-title">  {{ trans('purchases.Purchase') }}  </h3>
        </div>
       </div>
    </div>
                    ...
                    <div class="col-lg-8">
                      <div class="row">
                        ...
                        <div class="col-lg-3" id="paymentDate" style="display: none">
                          <div class="form-group">
                            <label for=""> {{ trans('purchases.Productcode') }}</label>
                            <input type="date" class="form-control @error('payDate') is-invalid @enderror" id="payDate" name="payDate" >
                            @error('payDate')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('serial') is-invalid @enderror" id="serial" name="serial" placeholder="{{ trans('purchases.Bookinvoicenumber') }}">
                            @error('serial')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('invoiceDate') is-invalid @enderror" value="<?php echo date('Y-m-d') ;?>" id="invoiceDate" name="invoiceDate" placeholder=" {{ trans('purchases.Invoicedate') }}">
                            @error('invoiceDate')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                onchange="ShowDecscontall()" name="Decscontall" placeholder="خصم">
                            </div>
                        </div>
