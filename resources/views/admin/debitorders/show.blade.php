...
<div class="invoice print">
  ...
  <div class="row" style="margin-top: 0px;">
    ...
    <div class="col-6">
      <h6 style="text-align: center;margin:5px">اشعار مدين للفاتورة الضريبية</h6>
      <h6 style="text-align: center;margin:5px">Debit note for the tax invoice</h6>
    ...
    <table class="col-12 mt-3 border for-print" style="margin:auto;float:none;text-align:center;padding:5px" >
      ...
      <tfoot>
        <tr>
          ...
          <td style="background-color: rgb(202, 199, 199);font-size:small">{{$order->totalwvat - $order->totalvat}} ريال</td>
        </tr>
        <tr>
          ...
          <td style="background-color: rgb(202, 199, 199);font-size:small">{{$order->totalvat}} ريال</td>
        </tr>
        <tr>
          ...
          <td style="background-color: rgb(202, 199, 199);font-size:small">{{$order->totalwvat}} ريال</td>
        </tr>
      </tfoot>
    </table>
  </div>
