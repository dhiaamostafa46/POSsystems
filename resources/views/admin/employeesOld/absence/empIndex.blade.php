    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-left">
          <li class="breadcrumb-item"><a href="#">طلبات الإستئذان</a></li>
          <li class="breadcrumb-item active">قائمة طلبات الإستئذان  </li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">طلبات الإستئذان </h3>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  @else
                      <tr>
                        <td colspan="7" class="text-center">لا توجد طلبات إستئذان  </td>
                      </tr>
                  @endif
                  </tfoot>
                </table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-center" id="exampleModalLabel"> تقديم طلب إستئذان </h5>
          ...
          <div class="row">
            <div class="col-lg-5">
              <div class="form-group">
                <label class="form-control-label" for="input-username">من الساعه   :</label>
                <input type="time" name="dateFrom" class="form-control">
            ...
            <div class="col-lg-5">
              <div class="form-group">
                <label class="form-control-label" for="input-username">إلى الساعة   :</label>
                <input type="time" name="dateFrom" class="form-control">
            ...
            <div class="col-lg-11">
              <div class="form-group">
                <label class="form-control-label" for="input-username">السبب</label>
