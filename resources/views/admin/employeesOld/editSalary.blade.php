...
<section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            <form class="user" method="POST" action="{{ route('employees.updateInfo',['id'=>$empSal->id,'type'=>'salary']) }}" enctype = "multipart/form-data">
              @csrf
              @method('put')
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">بيانات الراتب - {{$empSal->employee->nameAr}}</h3>
                </div>
                <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                            <input type="hidden"  class="form-control" name="empID" value="{{$empSal->id}}">
                            <label class="form-control-label" for="input-username">الراتب الأساسي </label>
                            <input type="number"  class="form-control @error('basicSalary') is-invalid @enderror"  id="basicSalary" name="basicSalary" value="{{$empSal->basicSalary}}" onchange="todefault(this)">
                            @error('basicSalary')
                        ...
                        <div class="col-lg-8">
                          ...
                          <table class="table table-bordered table-hover">
                            ...
                            <tr>
                              ...
                              <!--<th> Code ID</th>-->
                              @if (count($empalown) > 0)
                              <input type="hidden" value="{{count($empalown)}}" id="alowncount">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td><input type="number"  class="form-control @error('name') is-invalid @enderror"   value="{{$allowan->value}}" name="allow{{$index}}" id="allow{{$index}}" onchange="todefault(this)"></td>
                        ...
                        <div class="col-lg-8">
                          ...
                          <table class="table table-bordered table-hover">
                            ...
                            <tr>
                              ...
                              <input type="hidden" value="{{count($empdeduct)}}" id="dedcount">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td><input type="number"  class="form-control @error('name') is-invalid @enderror" name="ded{{$index}}"  id="ded{{$index}}" value="{{$ded->value}}" onchange="todefault(this)"></td>
