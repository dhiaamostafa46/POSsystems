    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-left">
          ...
          <li class="breadcrumb-item active">قائمة الرواتب</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h6 style="display: inline-block">الرواتب </h6>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <br>
                        <button class="btn btn-primary" style="width: 50%;display:inline-block" id="addbtn" disabled>إضافة الراتب</button>
                      </div>
                    </div>
                  </div>
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody id="salaries">
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{route('employees.showSalary',$salary->employee->id)}}" class="btn btn-primary"><i class="fa fa-eye"></i> تفاصيل</a>
                        <a href="{{route('employees.editSalary',$salary->id)}}" type="button" class="btn btn-info"><i class="fa fa-edit"></i> تعديل</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-center" id="exampleModalLabel"> بدل جديد  </h5>
