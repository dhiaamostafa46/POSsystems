...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">المستندات </h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-left">
          <li class="breadcrumb-item"><a href="#">المستندات </a></li>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h6 style="display: inline-block">المستندات </h6>
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <br>
                          <button class="btn btn-primary" style="width: 50%;display:inline-block" onclick="showModal()" id="addbtn" disabled>إضافة مستند</button>
                        </div>
                      </div>
                    </div>
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  @if (!empty($docs))
                      ...
                      <tr>
                        ...
                        <td><a href="{{asset('dist/empDocs/'.$doc->doc)}}" target="_blank">عرض المستند</a></td>
                        <td>{{$doc->created_at}}</td>
                        <td>
                          <a href="{{route('employees.show',$doc->id)}}" class="btn btn-primary"><i class="fa fa-eye"></i> عرض</a>
                          <a type="button" class="btn btn-info" onclick="showEditModal('EditModal',{{ $doc->id }})"><i class="fa fa-edit"></i> تعديل</a>
                          <a href="#" class="btn btn-danger" onclick="handleDelete({{ $doc->id }})"><i class="fa fa-trash"></i> حذف</a>
                        </td>
                      </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-center" id="exampleModalLabel"> تعديل مستند   </h5>
      ...
      <form class="user" method="POST" action="{{route('employees.updateInfo',['id'=>$doc->id,'type'=>'doc'])}}" enctype = "multipart/form-data">
        ...
        <div class="pl-lg-4">
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group">
                <label class="form-control-label" for="input-username">نوع المستند</label>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                <label class="form-control-label" for="input-username">رفع المستند</label>
    ...
    <!-- End Edit Modal -->
                  ...
                  @else
                      <tr>
                        <td colspan="5" class="text-center">لا يوجد مستندات</td>
                      </tr>
                  @endif
                  </tfoot>
                </table>
...
<div class="modal fade modal" id="CreateModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-center" id="exampleModalLabel"> مستند جديد  </h5>
       <!--<button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>-->
      </div>
