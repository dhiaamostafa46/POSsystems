          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">طلبات السلفيات </h3>
                ...
                <div class="col-3">
                <br>
                  <label for="">السقف :</label>
                  <label for="">1000 ريال </label>
                </div>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  @else
                      <tr>
                        <td colspan="7" class="text-center">لا توجد طلبات سلفيات  </td>
                      </tr>
                  @endif
                  </tfoot>
                </table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-center" id="exampleModalLabel"> تقديم طلب سلفية </h5>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group">
                <label class="form-control-label" for="input-username">المبلغ المطلوب  :</label>
                <input type="number"  class="form-control @error('amount') is-invalid @enderror" id="amount" name="amount" max="21" title="x">
