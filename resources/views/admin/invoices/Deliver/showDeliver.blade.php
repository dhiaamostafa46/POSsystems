        ...
        <div class="row">
            <div class="col-8">
                <h4>
                    ...
                    <br><br>
                    <img src="{{ asset('dist/img/organizations/' . auth()->user()->organization->logo) }}" style="width: 70px"
                        alt="">
                </h4>
            </div>
            <div class="col-4">
                <h4>
                    <br><br>
                    <small class="float-right">{{ trans('Sandat.address') }}: {{ auth()->user()->branch->area }} -
                        {{ auth()->user()->branch->city }} - {{ auth()->user()->branch->district }}</small><br>
            ...
            <div class="col-12">
                <h5 class="text-center"> {{ trans('Sandat.SinadatindexDeliver') }} </h5>
            </div>
            <!-- /.col -->
        </div>
        <hr>
                ...
                <table class="table table-striped">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th colspan="3">{{ $invoice->supplier->name ?? '' }}</th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <th colspan="3">{{ $invoice->supplier->phone ?? '' }}</th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <th colspan="3">{{ $invoice->invoicesID ?? '0' }}</th>
                        </tr>
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <div class="table-responsive">
                    <table class="table">
                        <tr>
                            <th>  {{ trans('Sandat.Delivertvoucher') }}</th>
