...
<div class="invoice print">
  ...
  <div class="row" style="margin-top: 0px;">
    ...
    <div class="col-6">
      ...
      <br>
      <h6 style="text-align: center;margin:5px"><strong>كشف الرواتب لشهر {{$month}}</strong></h6>
    ...
    <table class="col-12 mt-3 border for-print" style="margin:auto;float:none;text-align:center;padding:5px" >
      <thead>
        <tr  style="border: 1px solid #000;">
          ...
          @endforeach
          @foreach ($deducts as $index => $item2)
          <th style="font-size: small;background-color: rgb(202, 199, 199);">{{$item2->nameAr}} </th>
          @endforeach
       
          <th style="font-size: small;background-color: rgb(202, 199, 199);">الجزاءات</th>
          <th style="font-size: small;background-color: rgb(202, 199, 199);">السلفيات</th>
      ...
      <tfoot>
        ...
        $col = $allam +3;
      ?>
      <th colspan="2">الإجمالي</th><th colspan="{{$col}}">{{$allNetSal}}</th> 
