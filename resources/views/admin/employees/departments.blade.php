...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"> {{ trans('HR.departments') }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb floatmleft">
                        <li class="breadcrumb-item"><a href="#">{{ trans('HR.employees') }}</a></li>
                        <li class="breadcrumb-item active"> {{ trans('HR.departments') }}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 style="display: inline-block">{{ trans('HR.departments') }} </h6>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a type="button" class="btn btn-info"
                                                        onclick="showEditModal('EditModal',{{ $depart->id }})"><i
                                                            class="fa fa-edit"></i> {{ trans('HR.Edit') }}</a>
                                                    <a href="#" class="btn btn-danger"
                                                        onclick="handleDelete({{ $depart->id }})"><i
    ...
    <div class="modal fade modal" id="CreateModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-center" id="exampleModalLabel"> {{ trans('HR.Newdepartments') }} </h5>
                </div>
    ...
    function handleDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "/deleteItem/" + id + "/" + "depart";
            }
        })
    }
