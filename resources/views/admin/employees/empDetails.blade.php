              ...
              <div class="card-body">
                  <div class="pl-lg-4">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-3">
                        <div class="form-group">
                          {{-- {{asset('dist/empDocs/contracts/'.$employee->contract($employee->id)->file ?: '')}} --}}
                          <a href="#" target="_blank"  class="btn btn-primary" style="float:left"><i class="fa fa-show"></i> إستعراض عقد العمل </a>
