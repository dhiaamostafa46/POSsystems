...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"> {{ trans('HR.Typesofnotices') }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb floatmleft">
                        <li class="breadcrumb-item"><a href="#">{{ trans('HR.employees') }}</a></li>
                        <li class="breadcrumb-item active"> {{ trans('HR.Typesofnotices') }}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 style="display: inline-block"> {{ trans('HR.Typesofnotices') }}</h6>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form class="user" method="POST"
                                                                        action="{{ route('notics.notTypeupdate',$type->id) }}"
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            ...
                                                                                            id="nameAr" name="nameAr" value="{{ $type->nameAr }}" required>
                                                                                        @error('nameAr')
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            ...
                                                                                            id="nameEn" name="nameEn"  value="{{ $type->nameEn }}" required>
                                                                                        @error('nameEn')
                                                                                            <span class="invalid-feedback"
                                                                                                role="alert">
                                                                                                <strong>{{ $message }}</strong>
    ...
    <div class="modal fade modal" id="CreateModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-center" id="exampleModalLabel"> {{ trans('HR.Newnotices') }} </h5>
                </div>
                <div class="modal-body">
                    <form class="user" method="POST" action="{{ route('notics.storeType') }}"
                        enctype = "multipart/form-data">
                        @csrf
                        <div class="pl-lg-4">
                            <div class="row">
