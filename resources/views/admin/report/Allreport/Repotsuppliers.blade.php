...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">   {{ trans('Report.Supplierdata') }}   </h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb floatmleft">
                <li class="breadcrumb-item"><a href="#">   {{ trans('Report.Listofreports') }}</a></li>
                <li class="breadcrumb-item active">   {{ trans('Report.Supplierdata') }} </li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                            ...
                            <table id="RepotAllDataTable" class="table table-bordered table-hover">
                                ...
                                @if (count($suppliers) > 0)
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <a href="{{route('ReportAll.supplierShow',$supplier->id)}}" class="btn btn-primary"><i class="fa fa-eye"></i>  {{ trans('Report.Show') }}</a>
                                      </td>
                                    </tr>
                                    @endforeach
                                @else
