...
<div class="invoice p-3 mb-3">
  ...
  <hr>
  <h5>       {{ trans('Report.Rankingofitemprofitability') }}    </h5>
  <hr>
    <!-- Table row -->
    <div class="row">
      <div class="col-12">
            ...
            <table id="example3" class="table table-bordered table-hover" style="width: 95%">
              <thead>
                <tr>
                  ...
                  <th> {{ trans('Report.product') }} </th>
                  <th>  {{ trans('Report.Quantitysold') }} </th>
                  <th>  {{ trans('Report.Unit') }}  </th>
                  <th>  {{ trans('Report.Profitability') }} </th>
                </tr>
                </thead>
                <tbody>
                ...
                @if (count($stocks) > 0)
                    ...
                    @if ($product->saller!=0)
                        <tr>
                            ...
                            <td>{{ $product->saller * $product->costprodect }}</td>
