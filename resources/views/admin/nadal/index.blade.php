                  ...
                  @if (count($orders) > 0)
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          {{-- <a href="{{route('Nadal.edit',$order->id)}}" class="btn btn-info"><i class="fa fa-eye"></i> تعديل</a> --}}
                          @if ($order->kind ==1)
                            <a  onclick="handleDelete({{ $order->id }})"  target="_blank" class="btn btn-danger"><i class="fa fa-trash"></i>  {{ trans('Sale.cancel') }}</a>
                          @endif
                        </td>
                      </tr>
                      @endforeach
