  ...
  <div class="cs-container">
    <div class="cs-invoice cs-style1">
        <div class=" cs-hide_print">
            <a href="javascript:window.print()" class="btn btn-default" style="margin-right: 5px;"><i class="fas fa-print"></i> طباعة</a>
        ...
        <div class="cs-invoice_in" id="download_section">
            ...
            <div class="text-center">
                <p class="cs-invoice_number cs-primary_color cs-mb5 cs-f16"><b class="cs-primary_color"> فاتورة ضريبة</b></p>
