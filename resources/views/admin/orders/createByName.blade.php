                      ...
                      <div class="col-lg-12">
                        <div class="form-group">
                          @if(count(auth()->user()->branch->durations)>0)
                            ...
                            <input type="hidden"  class="form-control @error('barcode') is-invalid @enderror" id="barcode" name="barcode" placeholder="كود المنتج" autofocus onchange="getBarcode(this.value)">
                            <input type="text" class="autocomplete form-control @error('prodName') is-invalid @enderror" id="prodName" name="prodName" placeholder="اكتب اسم المنتج">
                            @else
