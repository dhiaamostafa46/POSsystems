...
<section class="content">
      <div class="container-fluid">
        ...
        <div class="row mt-2">
          ...
          <div class="col-5">
            <div class="card card-primary  text-primary" style="height: 110px ;;background-color: #02beb6;">
              <div class="card-body">
          ...
          <div class="col-4">
            <div class="card card-primary" style="height: 110px ;background-color: #02beb6;">
              <div class="card-body">
                <form class="user" method="POST" action="#" enctype = "multipart/form-data">
                  @csrf
                  <div class="pl-lg-4">
                ...
                <div class="row">
                  <div class="col-lg-8">
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="form-group">
                              <input type="text"  class="form-control @error('area') is-invalid @enderror" id="ٌRef" name="Ref" placeholder="رقم الفاتورة">
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                ...
                <table class="table table-borderless text-center">
                    <tbody>
                        @if(count(auth()->user()->branch->durations)>0)
                            @if(auth()->user()->branch->durations->first()->status==1)
                                <tr>
                                    <th scope="row"><h6 class="col-md-6">حالة الدوام: <strong class='text-success'>مفتوح</strong></h6></th>
                                    <td> <h6 class="col-md-6">زمن بدء الدوام: <strong>{{auth()->user()->branch->durations->first()->created_at}}</strong></h6></td>
                                    <td> <h6 class="col-md-6">رقم الدوام: <strong>{{auth()->user()->branch->durations->first()->durationNo}}</strong></h6> </td>
                                    <td><h6 class="col-md-6">المستخدم: <strong>{{auth()->user()->branch->durations->first()->user->name}}</strong></h6></td>
                                    <td><h6> <a href="#" onclick="endDuration({{auth()->user()->branch->durations->first()->id}});" class="btn btn-danger"><i class="fa fa-times"></i> انهاء الدوام </a></h6></td>
                                </tr>
                            @else
                                    <tr>
                                        <td> <h6 class="col-md-6">حالة الدوام: <strong class='text-danger'>مغلق</strong></h6></td>
                                        <td><h6 class="col-md-6"><a href="#" onclick="startDuration();" class="btn btn-primary" style="width:100%">بدء الدوام</a></h6></td>
                                    </tr>
                            @endif
                        @else
                            <tr>
