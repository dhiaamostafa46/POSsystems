                                                            ...
                                                            <tr>
                                                                ...
                                                                @else
                                                                    <td style="font-size: large">
                                                                        {{ number_format($details->total / 1.15, 2) }}</td>
                                                                    <td style="font-size: large">
                                                                        {{ number_format($details->total - $details->total / 1.15, 2) }}
                                                                    </td>
                                                                    <td style="font-size: large">
                                                                        {{ number_format($details->total) }}</td>
                                                                    <?php $total += number_format($details->total / 1.15, 2);
                                                                    $vat += number_format($details->total - $details->total / 1.15, 2);
                                                                    $alltotal += $details->total; ?>
                                                                @endif
                            ...
                            <div class="row no-print">
                                <div class="col-12">
                                    @if (!empty(auth()->user()->organization->vatNo))
                                        <a href="{{ route('OrderInvoices.showInv', $order->id) }}"
