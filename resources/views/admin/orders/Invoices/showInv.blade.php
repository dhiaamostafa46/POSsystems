                ...
                <div class="cs-invoice_head cs-type1 cs-mb25">
                    ...
                    <div class="text-center">
                        ...
                        <p class="cs-invoice_date cs-primary_color cs-m0"><b
                                class="cs-primary_color">   @if ($order->TypeInv == 2)
                        ...
                        <p>
                            <span> {{ trans('Sale.customername') }} : @if ($order->FlageCustumer == -1)
                                ...
                                @else
                                    {{ $order->Customer->name ?? '' }}
                                @endif </span> <br>
                            <span> {{ trans('Sale.Customertaxnumber') }} : @if ($order->FlageCustumer == -1)
                                            ...
                                            <tr>
                                                ...
                                                @if ($order->orderType == 4)
                                                    ...
                                                    <td style="font-size: large">
                                                        {{ $item->price * $item->quantity - $item->total }}</td>
                                                @endif
                                                <td style="font-size: large">{{ number_format($item->total / 1.15) }}</td>
                                                <td style="font-size: large">
                                                    {{ number_format($item->total - $item->total / 1.15) }}</td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cs-border_left">
                                            ...
                                            <td
                                                ...
                                                {{ number_format($order->totalwvat, 2) }} {{ trans('Sale.Rial') }} </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
