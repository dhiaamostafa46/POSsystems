...
@section('content')
            ...
            <div class="row mt-2">
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <form class="user" method="POST" action="{{ route('OrderInvoices.store') }}"
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <select class="form-control @error('type') is-invalid @enderror"
                                                        ...
                                                        required>
                                                        <option value=""> {{ trans('Sale.paymentmethod') }}
                                                        </option>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <input type="datetime-local" class="form-control" id="ordertime"
                                                        name="ordertime" value="{{ date('Y-m-d H:i:s') }}"
    ...
    <script>
                ...
                success: data => {
                    ...
                    if (data.flage == 0) {
                        ...
                        data.items.forEach(item => {
                            ...
                            <td>${count}</td>
                            <td>${item.nameAr}</td>
                            <td><input type="number" min="0.00" step="any"   class="form-control text-center" id="price${count}" name="price${count}" value="${item.prodPrice}" onchange="calculate(${count})" ></td>>
                            ...
                            <td><input type="number" min="0.00" step="any"  class="form-control text-center"  id="discountval${count}" name="discountval${count}" value="${data.discount}" onchange="calculatediscount(${count})"></td>
        ...
        function calculatediscount(id) {
            ...
            document.getElementById('Decscontall').readOnly = true;
        }
        ...
        function CopyItems(id) {
            ...
            $('#tbody').append(`
                            ...
                            <td><input type="number" min="0.00" step="any"  class="form-control text-center"  id="discountval${count}" name="discountval${count}" value="${$('#discountval'+id).val()}" onchange="calculatediscount(${count})"></td>
