...
@section('content')
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <input   type="datetime-local" class="form-control" id="ordertime" name="ordertime" value="{{date('Y-m-d H:i:s')}}" max="{{date('Y-m-d H:i:s')}}" />
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
    ...
    <!-- Customers Modal -->
    <div class="modal fade modal" id="customersModel" tabindex="-1" role="dialog"
                            ...
                            <div class="pl-lg-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="text"
                                                ...
                                                name="area" placeholder="اكتب المنطقة">
                                            @error('area')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="text"
                                                ...
                                                name="city" placeholder="اكتب المدينة">
                                            @error('city')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="text"
                                                ...
                                                id="district" name="district" placeholder="اكتب المدينة">
                                            @error('district')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="text"
                                                ...
                                                id="address" name="address" placeholder="اكتب العنوان">
                                            @error('address')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="text"
                                                class="form-control @error('vatNo') is-invalid @enderror" id="vatNo"
                                                name="vatNo" placeholder="اكتب الرقم الضريبي">
                                            @error('vatNo')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="tel"
                                                ...
                                                name="phone" placeholder="اكتب رقم الجوال">
                                            @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="email"
                                                ...
                                                name="email" placeholder="اكتب البريد الالكتروني">
                                            @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-primary" style="width: 100%"
                                                onclick="storeCustomer()">حفظ</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
