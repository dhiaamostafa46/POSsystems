    ...
    <div id="invoice-POS">
        ...
        <center id="top">
            <div class="logo">
                @if (!empty(auth()->user()->organization->logo) && auth()->user()->organization->logo != 'default.png')
                    <img width="60" height="60"
                        src="{{ asset('dist/img/organizations/' . auth()->user()->organization->logo) }}">
                @endif
            ...
            <div class="info">
                ...
                <p>{{ auth()->user()->branch->area }} - {{ auth()->user()->branch->city }} -
                    {{ auth()->user()->branch->district }}</p>
                <div>
                ...
                <div>
                    <p>العميل: {{ $order->customer->name ?? 'لايوجد' }}
                        <br>
                        الرقم الضريبي للعميل: {{ $order->customer->vatNo ?? '' }}
                    </p>
                </div>
                            ...
                            <tr class="service">
                                ...
                                <td class="tableitem">
                                    @if (auth()->user()->organization->activity == 2)
                                        <p class="itemtext">
                                            {{ number_format(($item->price * $item->quantity + $item->Extratotal) / 1.15, 2) }}
                                        </p>
                                    @else
                                        <p class="itemtext">
                                            {{ number_format($item->price * $item->quantity + $item->Extratotal) }}
                                        </p>
                                    @endif
            ...
            <center>
                <div class="qr">
                    <div class="col-3  d-flex justify-content-center">
                        <div class="col-xs-3 d-flex justify-content-center" style="    margin-top: 60px;">
                            <div class="demo d-flex justify-content-center" style="display: block"></div>
                        </div>
