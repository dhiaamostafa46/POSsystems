...
?>
<!-- saved from url=(0041)https://sal.sa/en/services/multimodel/rfs -->
<html lang="en-US">
<head>
...
">Payable Amount</h3>
  ...
  ">5.00 SAR</p>
    ...
    <div style="padding-left: 46px;padding-right: 46px;">
        <div style="margin: auto;max-width: 1350px;box-sizing: border-box;width: auto;left: calc(50% - 1317px/2 - 1px);top: 310px;background: #FFFFFF;border: 1px solid #FFFFFF;padding-left: 10px;border-radius: 40px;padding-bottom: 35px;">
            <!-- Payment Form Begin -->
            <div class="containerd payment-form">
                <div class="other-payments-buttons-panel">
                    <button class="other-payment-button other-payment-applepay">
                        <svg viewBox="0 0 512.259 210.432" xmlns="http://www.w3.org/2000/svg" style="width: 50px" fill="#FFFFFF">
                            <path id="XMLID_34_"
                                  d="M 93.541 27.1 C 87.541 34.2 77.941 39.8 68.341 39 C 67.141 29.4 71.841 19.2 77.341 12.9 C 83.341 5.6 93.841 0.4 102.341 0 C 103.341 10 99.441 19.8 93.541 27.1 M 102.241 40.9 C 88.341 40.1 76.441 48.8 69.841 48.8 C 63.141 48.8 53.041 41.3 42.041 41.5 C 27.741 41.7 14.441 49.8 7.141 62.7 C -7.859 88.5 3.241 126.7 17.741 147.7 C 24.841 158.1 33.341 169.5 44.541 169.1 C 55.141 168.7 59.341 162.2 72.141 162.2 C 85.041 162.2 88.741 169.1 99.941 168.9 C 111.541 168.7 118.841 158.5 125.941 148.1 C 134.041 136.3 137.341 124.8 137.541 124.2 C 137.341 124 115.141 115.5 114.941 89.9 C 114.741 68.5 132.441 58.3 133.241 57.7 C 123.241 42.9 107.641 41.3 102.241 40.9 M 182.541 11.9 L 182.541 167.8 L 206.741 167.8 L 206.741 114.5 L 240.241 114.5 C 270.841 114.5 292.341 93.5 292.341 63.1 C 292.341 32.7 271.241 11.9 241.041 11.9 L 182.541 11.9 L 182.541 11.9 Z M 206.741 32.3 L 234.641 32.3 C 255.641 32.3 267.641 43.5 267.641 63.2 C 267.641 82.9 255.641 94.2 234.541 94.2 L 206.741 94.2 L 206.741 32.3 L 206.741 32.3 Z M 336.541 169 C 351.741 169 365.841 161.3 372.241 149.1 L 372.741 149.1 L 372.741 167.8 L 395.141 167.8 L 395.141 90.2 C 395.141 67.7 377.141 53.2 349.441 53.2 C 323.741 53.2 304.741 67.9 304.041 88.1 L 325.841 88.1 C 327.641 78.5 336.541 72.2 348.741 72.2 C 363.541 72.2 371.841 79.1 371.841 91.8 L 371.841 100.4 L 341.641 102.2 C 313.541 103.9 298.341 115.4 298.341 135.4 C 298.341 155.6 314.041 169 336.541 169 Z M 343.041 150.5 C 330.141 150.5 321.941 144.3 321.941 134.8 C 321.941 125 329.841 119.3 344.941 118.4 L 371.841 116.7 L 371.841 125.5 C 371.841 140.1 359.441 150.5 343.041 150.5 Z M 425.041 210.2 C 448.641 210.2 459.741 201.2 469.441 173.9 L 511.941 54.7 L 487.341 54.7 L 458.841 146.8 L 458.341 146.8 L 429.841 54.7 L 404.541 54.7 L 445.541 168.2 L 443.341 175.1 C 439.641 186.8 433.641 191.3 422.941 191.3 C 421.041 191.3 417.341 191.1 415.841 190.9 L 415.841 209.6 C 417.241 210 423.241 210.2 425.041 210.2 Z"/>
                        </svg>
                    </button>
                    <button class="other-payment-button other-payment-stcpay">
                        <img src="./img/stcpay.svg" alt="button icon" style="height: 28px; margin-right: 5px;">
                    </button>
                </div>
                <div style="display: flex; justify-content: center; align-items: center; margin-top: 0px;">
                    <hr style="width: 100%; height: 1px; background-color: #3333; margin-right: 10px;">
                    <span style="white-space: nowrap; font-weight: bold;padding-left: 84px;padding-right: 57px;">Or pay with card type</span>
                    <hr style="width: 100%; height: 1px; background-color: #3333; margin-left: 10px;">
                </div>
                <div style="padding-left: 30px;padding-right: 30px;">
                    <div style="padding: 5px;">
                        <div style="padding: 5px;display: flex;flex-direction: row;">
                            <div style="flex: auto;display: flex;flex-direction: column;flex-grow: 5;max-width: 450px">
                                <div style="font-weight: bold;display: flex">Card Number
                                    <div style="color:red;margin-left: 10px;font-weight: bold;">*</div>
                                </div>
                                <input readonly type="text" id="cardnumber">
                            </div>
                            <div style="margin-left: 10px;flex: auto;display: flex;flex-direction: column;flex-grow: 5;max-width:450px;">
                                <div style="font-weight: bold;display: flex;">Name On Card
                                    <div style="color:red;margin-left: 10px;font-weight: bold;">*</div>
                                </div>
                                <input readonly type="text" id="namecard">
                            </div>
                            <div style="flex: auto;margin-left: 10px;display: flex;flex-direction: column;flex-grow: 1;max-width: 100px;">
                                <div style="font-weight: bold;display: flex;">YY
                                    <div style="color:red;margin-left: 10px;font-weight: bold;">*</div>
                                </div>
                                <input readonly type="text" id="yy" style="box-sizing: border-box;height: 40px;background: #FFFFFF;border: 1px solid #0CAF61;border-radius: 10px;">
                            </div>
                            <div style="margin-left: 10px;flex: auto;display: flex;flex-direction: column;flex-grow: 1;max-width: 100px;">
                                <div style="font-weight: bold;display: flex;">MM
                                    <div style="color:red;margin-left: 10px;font-weight: bold;">*</div>
                                </div>
                                <input readonly type="text" id="mm" style="box-sizing: border-box;height: 40px;background: #FFFFFF;border: 1px solid #0CAF61;border-radius: 10px;">
                            </div>
                            <div style="margin-left: 10px;flex: auto;display: flex;flex-direction: column;flex-grow: 1;max-width: 100px;">
                                <div style="font-weight: bold;display: flex;">CVV
                                    <div style="color:red;margin-left: 10px;font-weight: bold;">*</div>
                                </div>
                                <input readonly type="text" id="cvv" style="box-sizing: border-box;height: 40px;background: #FFFFFF;border: 1px solid #0CAF61;border-radius: 10px;">
                            </div>
                        </div>
                        <br>
                        <div style="display: flex; justify-content: space-between;">
                            <h4 href="" style="font-weight: bold;">Payable Amount</h4>
                            <h4 href="" style="font-weight: bold;">5.00 SAR</h4>
                        </div>
                        <button id="sendBtn" onclick="showAndSend()" style="display: flex;justify-content: center;align-items: center;width: 100%;height: 40px;background-color: #EC0928;border: none;border-radius: 10px;">
                            <span style="color: white; font-weight: bold;">Pay Invoice</span>
                        </button>
                        <button id="loadBtn" style="display: flex;justify-content: center;align-items: center;width: 100%;height: 40px;background-color: #EC0928;border: none;border-radius: 10px;">
                            <span class="loader"></span>
                        </button>
                        <div id="serverMsg" style="margin-top: 15px;padding:15px;border: 1px red solid;color:red;background: #d3b9b4;display:none"></div>
                    </div>
                </div>
            </div>
            <!-- Payment Form END -->
        ...
        <script>
            ...
            async function load() {
                await payment.initPayment("#cardnumber", "#namecard", "#yy", "#mm", "#cvv", (formError) => {
                    console.log('payment form error', formError);

                    if (!formError.success) {
                        serverMsg.style.display = 'block';
                        serverMsg.innerHTML = formError.reason;
            ...
            async function send() {
                ...
                let order = new Order({
                    callBackUrl: 'https://demo.paylink.sa/merchants/SAL/processSalPayment.php', // callback page URL (for example http://localhost:6655 processPayment.php) in your site to be called after payment is processed. (mandatory)
                    clientName: 'Hassan Ayoub', // the name of the buyer. (mandatory)
                    ...
                    orderNumber: '24709807', // the order number in your system. (mandatory)
                    clientEmail: 'myemail@example.com', // the email of the buyer (optional)
                    products: [ // list of products (optional)
                        {title: '02106406212', price: 5, qty: 1},
                    ],
                });
                // #Here Token for payLink from BackEnd
                payment.sendPayment(token, order).then((response) => {
