...
(function ($) {
    var defaults = {
        ...
        spoilerButtonClickMinX: 50,
        spoilerButtonClickMaxX: 0,
        spoilerButtonClickMinY: 50,
        spoilerButtonClickMaxY: 0,
        slideEffect: true
    };
    ...
    var methods = {
        init: function (params) {
            ...
            var xAxis = items.width() - (items.width() * .9);
            var yAxis = items.width() - (items.width() * .9);

            defaults.spoilerButtonClickMaxX = xAxis;
            defaults.spoilerButtonClickMaxY = yAxis;
            ...
            $.each(parents, function (num, parent) {
                ...
                if (parent.has('.' + options.selectedClass)[0]) {
                    parent.removeClass(options.collapseClass).addClass(options.collapseClass);
