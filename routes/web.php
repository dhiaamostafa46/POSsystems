    ...
    [
        ...
        Route::group(['prefix' => 'Shop'], function() {
            ...
            Route::group(['middleware' => 'Shop.auth'], function(){
                ...
                Route::post('/savebooktable', [ProfileShopController::class, 'savebooktable'])->name('savebooktable');
...
Route::get('/PayNow',[App\Http\Controllers\ClientsController::class,'PayNow'])->name('PayNow');
Route::get('/callnadel',[App\Http\Controllers\ClientsController::class,'callnadel'])->name('callnadel');
Route::get('/getmassagenade',[App\Http\Controllers\ClientsController::class,'getmassagenade'])->name('getmassagenade');
Route::get('/maintable/{branch}/{id}',[App\Http\Controllers\ClientsController::class,'maintable'])->name('maintable');
...
Route::get('/storeTableClientPaylater/{id}',[App\Http\Controllers\ClientsController::class,'storeTableClientPaylater'])->name('storeTableClientPaylater');
...
Route::resource('Sitting', App\Http\Controllers\SittingController::class);
Route::resource('Expenses', App\Http\Controllers\ExpensesController::class);

Route::resource('Decmentype', App\Http\Controllers\DocumentypeController::class);

Route::post('/Prodcategoriesprice',[App\Http\Controllers\ProdcategoriesController::class,'catprodect'])->name('Prodcategoriesprice');



Route::get('deleteoutcomecategory/{id}', [App\Http\Controllers\OutcomecategoriesController::class, 'destroy'])->name('deleteoutcomecategory');


// Excal Route
Route::get('GetExportprodcategories/', [App\Http\Controllers\ProdcategoriesController::class, 'GetExportprodcategories'])->name('GetExportprodcategories');
Route::post('GetImportprodcategories/', [App\Http\Controllers\ProdcategoriesController::class, 'GetImportprodcategories'])->name('GetImportprodcategories');

Route::get('GetExportUnit/', [App\Http\Controllers\UnitsController::class, 'GetExportUnit'])->name('GetExportUnit');
Route::post('GetImportUnit/', [App\Http\Controllers\UnitsController::class, 'GetImportUnit'])->name('GetImportUnit');


Route::get('GetExportprodect/', [App\Http\Controllers\ProductsController::class, 'GetExportprodect'])->name('GetExportprodect');
Route::post('GetImportprodect/', [App\Http\Controllers\ProductsController::class, 'GetImportprodect'])->name('GetImportprodect');


Route::get('GetExportkitchens/', [App\Http\Controllers\KitchensController::class, 'GetExportkitchens'])->name('GetExportkitchens');
Route::post('GetImportkitchens/', [App\Http\Controllers\KitchensController::class, 'GetImportkitchens'])->name('GetImportkitchens');
// End Excal Route




Route::get('usersexport/', [App\Http\Controllers\UsersController::class, 'usersexport'])->name('exportUser');





Route::get('/totaldis',[App\Http\Controllers\OrderInvController::class,'totaldis'])->name('totaldis');
Route::get('/totaldispuch',[App\Http\Controllers\PurchasesController::class,'totaldispuch'])->name('totaldispuch');
Route::get('/totalcredor',[App\Http\Controllers\CredordersController::class,'totalcredor'])->name('totalcredor');
Route::get('/totaldept',[App\Http\Controllers\DebitordersController::class,'totaldept'])->name('totaldept');
Route::get('/Orderdept',[App\Http\Controllers\OrdersController::class,'Orderdept'])->name('Orderdept');
Route::get('/Orgstingall',[App\Http\Controllers\SittingController::class,'Orgstingall'])->name('Orgstingall');

Route::get('/outcomeitmes/{id}',[App\Http\Controllers\OutcomecategoriesController::class,'outcomeitmes'])->name('outcomeitmes');
Route::get('/Task.empindex',[App\Http\Controllers\TaskController::class,'empindex'])->name('Task.empindex');
Route::post('/changetask/{id}',[App\Http\Controllers\TaskController::class,'changetask'])->name('changetask');
Route::get('/totalcredor',[App\Http\Controllers\CredordersController::class,'totalcredor'])->name('totalcredor');
...
Route::get('/packagesitems/{id}',[SubsPacksController::class,'packagesitems'])->name('packagesitems');
...
Route::get('/Explanations', [TicketsController::class,'Explanations'])->name('Explanations');
...
Route::get('/contractsdelete/{id}', [EmployeesController::class,'contractsdelete'])->name('employees.contractsdelete');
...
Route::post('/updatesalaryAll/{id}', [EmployeesController::class,'updatesalaryAll'])->name('updatesalaryAll');
...
Route::post('/notTypeupdate/{id}', [NoticsController::class,'notTypeupdate'])->name('notics.notTypeupdate');
...
Route::get('/paynow',[SubsPacksController::class,'paynow'])->name('subsPack.paynow');

Route::get('/package-payment-response/{id}',[App\Http\Controllers\HomeController::class,'PackagePaymentResponse'])->name('payment.PackageResponse');
//oute::post('/toEmpAcceptRecive',[CastodiesController::class,'toEmpAcceptRecive'])->name('castodies.toEmpAcceptRecive');


Route::put('/storeSettingUpdate', [App\Http\Controllers\SittingController::class,'storeUpdate'])->name('setting.storeUpdate');


Route::put('/storeSettingUpdatelink', [App\Http\Controllers\SittingController::class,'storeSettingUpdatelink'])->name('storeSettingUpdatelink');

//-----------------------------------------------------
Route::get('/Accounting',[DescriptionController::class,'index'])->name('TreeDesc.index');
Route::get('/HRdescription',[DescriptionController::class,'HRdescription'])->name('HRdescription');
Route::get('/posdescription',[DescriptionController::class,'posdescription'])->name('posdescription');
Route::get('/restaurantdescription',[DescriptionController::class,'restaurantdescription'])->name('restaurantdescription');
Route::get('/menudescription',[DescriptionController::class,'menudescription'])->name('menudescription');
Route::get('/journalsdescription',[DescriptionController::class,'journalsdescription'])->name('journalsdescription');
Route::get('/Warehousesdescription',[DescriptionController::class,'Warehousesdescription'])->name('Warehousesdescription');
